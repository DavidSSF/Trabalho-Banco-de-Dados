...
<body>
    ...
    <script>
        function imprimirPagina() {
            var botaoImprimir = document.getElementById("imprimirBtn");
            botaoImprimir.style.display = "none"; // Oculta o botão antes da impressão

            window.onbeforeprint = function () {
                // Este bloco de código é executado antes da impressão começar
                console.log("Antes da impressão");
            };

            window.onafterprint = function () {
                // Este bloco de código é executado depois da impressão (ou se o usuário cancelar)
                console.log("Depois da impressão");
                botaoImprimir.style.display = "block"; // Torna o botão visível novamente
            };
